...
# Maak de functie goedenavond die "Goedenavond!" print op de console.



# Opdracht 1.3 - Functie met parameter
# Maak een functie genaamd "groet" die een parameter "naam" accepteert. 
# Zorg ervoor dat de naam op de console wordt geprint.



# Opdracht 1.4 - Functie om een keersom te maken
# Maak een functie genaamd "keer" die twee parameters accepteert.
